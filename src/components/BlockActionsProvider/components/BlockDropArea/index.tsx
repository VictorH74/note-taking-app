...
export function BlockDropArea({
  ...
  React.useEffect(() => {
    ...
    const blockList = document.getElementsByClassName(BLOCK_ITEM_CLASSNAME);
    ...
    <div className="absolute inset-0 overflow-hidden">
      {dropAreaDataList.map((data, i) => {
        ...
        return (
          ...
          >
            <div
              className="h-[3px] duration-300 w-full mx-auto group-hover:bg-green-300"
              style={{
                width: data.width,
              }}
            ></div>
